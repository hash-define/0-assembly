...
.preservation:
    mov [ebp-0x04], ebx         ; preserve the contents of ebx
    mov [ebp-0x08], esi         ; preserve the contents of esi
...
.loop_init:
    ...
    xor ebx, ebx                ; zero "i"
    xor esi, esi                ; zero "sum"

.loop_cond:
    ; Compare your loop counter here
    cmp ebx, 10                 ; compare "i" to 10
...
.loop_body:
    ...
    mov [esp+0x04], ebx ; pass "i" into arg1
    mov [esp+0x00], esi ; pass "sum" into arg0
    call sum_function
